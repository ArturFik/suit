...
class Pagination {
	...
	public function render() {
		...
		$output .= '</ul>';
				...
				if ($page > 1) {
					$output .= '<a class="pagination__item" href="' . str_replace(array('&amp;page={page}', '?page={page}', '&page={page}', '/page-{page}'), '', $this->url) . '">' . $this->text_first . '</a>';
					
					if ($page - 1 === 1) {
						$output .= '<a class="pagination__item" href="' . str_replace(array('&amp;page={page}', '?page={page}', '&page={page}', '/page-{page}'), '', $this->url) . '">' . $this->text_prev . '</a>';
					} else {
				...
				if ($num_pages > 1) {
					...
					for ($i = $start; $i <= $end; $i++) {
						if ($page == $i) {
							...
							if ($i === 1) {
								$output .= '<a class="pagination__item" href="' . str_replace(array('&amp;page={page}', '?page={page}', '&page={page}', '/page-{page}'), '', $this->url) . '">' . $i . '</a>';
							} else {
