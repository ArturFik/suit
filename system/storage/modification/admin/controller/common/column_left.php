...
if ($this->user->hasPermission('access', 'catalog/simplepars')) {
			...
			$cinewsletter = array();
			$this->load->language('newsletter/newsletter_menu');
			if ($this->user->hasPermission('access', 'newsletter/dashboard')) {
				$cinewsletter[] = array(
					'name'	   => $this->language->get('text_dashboard'),
					'href'     => $this->url->link('newsletter/dashboard', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'newsletter/cimailsetting')) {
				$cinewsletter[] = array(
					'name'	   => $this->language->get('text_cimailsetting'),
